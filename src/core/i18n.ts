...
const KO: Record<string, string> = {
  ...
  'SKUs': 'SKU',
  'Each top pick gets a four-view turnaround, then Tripo builds a GLB you can turn and download.': '최종 후보마다 4면 턴어라운드를 만들어 Tripo가 GLB를 생성합니다. 돌려 보고 내려받을 수 있습니다.',
  'A four-view turnaround of each pick goes to Tripo. You get a GLB you can turn and download.': '후보마다 4면 턴어라운드가 Tripo로 갑니다. 돌려 보고 내려받을 수 있는 GLB가 나옵니다.',
